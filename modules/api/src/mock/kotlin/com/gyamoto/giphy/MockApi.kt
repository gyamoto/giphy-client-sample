...
import com.gyamoto.api.BuildTypeConfig
...
class Mock(private val delegate: BehaviorDelegate<Api>) : Api {
    ...
    override fun search(
        ...
        return delegate.returningResponse(com.gyamoto.api.model.mock.PaginationResponse.mock)
    ...
    override fun random(
        ...
        return delegate.returningResponse(com.gyamoto.api.model.mock.RandomResponse.mock)
